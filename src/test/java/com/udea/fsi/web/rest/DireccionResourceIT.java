...
import static com.udea.fsi.domain.DireccionAsserts.*;
import static com.udea.fsi.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.udea.fsi.repository.DireccionRepository;
...
class DireccionResourceIT {
    ...
    void partialUpdateDireccionWithPatch() throws Exception {
        ...
        partialUpdatedDireccion.provincia(UPDATED_PROVINCIA);
