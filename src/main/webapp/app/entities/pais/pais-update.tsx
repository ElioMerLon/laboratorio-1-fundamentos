  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.pais.home.createOrEditLabel" data-cy="PaisCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.pais.home.createOrEditLabel">Create or edit a Pais</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.pais.nombrePais')}
                id="pais-nombrePais"
                name="nombrePais"
                data-cy="nombrePais"
                type="text"
              />
              <ValidatedField id="pais-region" name="region" data-cy="region" label={translate('fsijhipsterApp.pais.region')} type="select">
                <option value="" key="0" />
                {regions
