  ...
  return (
    <div>
      <h2 id="tarea-heading" data-cy="TareaHeading">
        <Translate contentKey="fsijhipsterApp.tarea.home.title">Tareas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fsijhipsterApp.tarea.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tarea/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fsijhipsterApp.tarea.home.createLabel">Create new Tarea</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tareaList && tareaList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fsijhipsterApp.tarea.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="fsijhipsterApp.tarea.trabajo">Trabajo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fsijhipsterApp.tarea.home.notFound">No Tareas found</Translate>
            </div>
          )
        )}
      </div>
