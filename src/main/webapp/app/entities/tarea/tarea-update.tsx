  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.tarea.home.createOrEditLabel" data-cy="TareaCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.tarea.home.createOrEditLabel">Create or edit a Tarea</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.tarea.titulo')}
                id="tarea-titulo"
                name="titulo"
                data-cy="titulo"
                type="text"
              />
              <ValidatedField
                label={translate('fsijhipsterApp.tarea.descripcion')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.tarea.trabajo')}
                id="tarea-trabajo"
                data-cy="trabajo"
                type="select"
                multiple
