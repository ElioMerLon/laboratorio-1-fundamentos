  ...
  return (
    <div>
      <h2 id="region-heading" data-cy="RegionHeading">
        <Translate contentKey="fsijhipsterApp.region.home.title">Regions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fsijhipsterApp.region.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/region/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fsijhipsterApp.region.home.createLabel">Create new Region</Translate>
          </Link>
        </div>
      </h2>
        ...
        {regionList && regionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fsijhipsterApp.region.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nombreRegion')}>
                  <Translate contentKey="fsijhipsterApp.region.nombreRegion">Nombre Region</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fsijhipsterApp.region.home.notFound">No Regions found</Translate>
            </div>
          )
        )}
      </div>
