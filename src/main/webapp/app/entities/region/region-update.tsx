  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.region.nombreRegion')}
