  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.direccion.home.createOrEditLabel" data-cy="DireccionCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.direccion.home.createOrEditLabel">Create or edit a Direccion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.direccion.calle')}
                id="direccion-calle"
                name="calle"
                data-cy="calle"
                type="text"
              />
              <ValidatedField
                label={translate('fsijhipsterApp.direccion.codigoPostal')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.direccion.ciudad')}
                id="direccion-ciudad"
                name="ciudad"
                data-cy="ciudad"
                type="text"
              />
              <ValidatedField
                label={translate('fsijhipsterApp.direccion.provincia')}
              ...
              <ValidatedField
                ...
                name="pais"
                data-cy="pais"
                label={translate('fsijhipsterApp.direccion.pais')}
                type="select"
              >
                <option value="" key="0" />
                {pais
