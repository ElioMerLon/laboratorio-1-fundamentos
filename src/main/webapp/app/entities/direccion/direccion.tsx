  ...
  return (
    <div>
      <h2 id="direccion-heading" data-cy="DireccionHeading">
        <Translate contentKey="fsijhipsterApp.direccion.home.title">Direccions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fsijhipsterApp.direccion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/direccion/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fsijhipsterApp.direccion.home.createLabel">Create new Direccion</Translate>
          </Link>
        </div>
      </h2>
        ...
        {direccionList && direccionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fsijhipsterApp.direccion.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('calle')}>
                  <Translate contentKey="fsijhipsterApp.direccion.calle">Calle</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('calle')} />
                </th>
                <th className="hand" onClick={sort('codigoPostal')}>
                  <Translate contentKey="fsijhipsterApp.direccion.codigoPostal">Codigo Postal</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('codigoPostal')} />
                </th>
                <th className="hand" onClick={sort('ciudad')}>
                  <Translate contentKey="fsijhipsterApp.direccion.ciudad">Ciudad</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('ciudad')} />
                </th>
                <th className="hand" onClick={sort('provincia')}>
                  <Translate contentKey="fsijhipsterApp.direccion.provincia">Provincia</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('provincia')} />
                </th>
                <th>
                  <Translate contentKey="fsijhipsterApp.direccion.pais">Pais</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fsijhipsterApp.direccion.home.notFound">No Direccions found</Translate>
            </div>
          )
        )}
      </div>
