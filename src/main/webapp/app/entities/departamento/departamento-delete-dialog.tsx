...
export const DepartamentoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fsijhipsterApp.departamento.delete.question">
        <Translate contentKey="fsijhipsterApp.departamento.delete.question" interpolate={{ id: departamentoEntity.id }}>
