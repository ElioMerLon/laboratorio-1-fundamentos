  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.departamento.home.createOrEditLabel" data-cy="DepartamentoCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.departamento.home.createOrEditLabel">Create or edit a Departamento</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.departamento.nombreDepartamento')}
              ...
              <ValidatedField
                ...
                name="direccion"
                data-cy="direccion"
                label={translate('fsijhipsterApp.departamento.direccion')}
                type="select"
              >
                <option value="" key="0" />
                {direccions
