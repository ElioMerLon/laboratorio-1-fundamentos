  ...
  return (
    <div>
      <h2 id="contrato-heading" data-cy="ContratoHeading">
        <Translate contentKey="fsijhipsterApp.contrato.home.title">Contratoes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fsijhipsterApp.contrato.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contrato/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fsijhipsterApp.contrato.home.createLabel">Create new Contrato</Translate>
          </Link>
        </div>
      </h2>
          ...
          {contratoList && contratoList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="fsijhipsterApp.contrato.id">ID</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
                  <th className="hand" onClick={sort('fechaInicio')}>
                    <Translate contentKey="fsijhipsterApp.contrato.fechaInicio">Fecha Inicio</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('fechaInicio')} />
                  </th>
                  <th className="hand" onClick={sort('fechaFin')}>
                    <Translate contentKey="fsijhipsterApp.contrato.fechaFin">Fecha Fin</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('fechaFin')} />
                  </th>
                  <th className="hand" onClick={sort('lenguaje')}>
                    <Translate contentKey="fsijhipsterApp.contrato.lenguaje">Lenguaje</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('lenguaje')} />
                  </th>
                  <th>
                    <Translate contentKey="fsijhipsterApp.contrato.trabajo">Trabajo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="fsijhipsterApp.contrato.departamento">Departamento</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="fsijhipsterApp.contrato.empleado">Empleado</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {contratoList.map((contrato, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      <Translate contentKey={`fsijhipsterApp.Idioma.${contrato.lenguaje}`} />
                    </td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="fsijhipsterApp.contrato.home.notFound">No Contratoes found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
