  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.contrato.home.createOrEditLabel" data-cy="ContratoCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.contrato.home.createOrEditLabel">Create or edit a Contrato</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.contrato.fechaInicio')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.contrato.fechaFin')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.contrato.lenguaje')}
              ...
              >
                {idiomaValues.map(idioma => (
                  <option value={idioma} key={idioma}>
                    {translate(`fsijhipsterApp.Idioma.${idioma}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="trabajo"
                data-cy="trabajo"
                label={translate('fsijhipsterApp.contrato.trabajo')}
                type="select"
              >
                <option value="" key="0" />
                {trabajos
              ...
              <ValidatedField
                ...
                label={translate('fsijhipsterApp.contrato.departamento')}
                type="select"
              >
                <option value="" key="0" />
                {departamentos
              ...
              <ValidatedField
                ...
                name="empleado"
                data-cy="empleado"
                label={translate('fsijhipsterApp.contrato.empleado')}
                type="select"
              >
                <option value="" key="0" />
                {empleados
