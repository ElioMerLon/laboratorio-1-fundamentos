    ...
    <Row>
      <Col md="8">
        <h2 data-cy="contratoDetailsHeading">
          <Translate contentKey="fsijhipsterApp.contrato.detail.title">Contrato</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="fsijhipsterApp.contrato.trabajo">Trabajo</Translate>
          </dt>
          <dd>{contratoEntity.trabajo ? contratoEntity.trabajo.id : ''}</dd>
          <dt>
            <Translate contentKey="fsijhipsterApp.contrato.departamento">Departamento</Translate>
          </dt>
          <dd>{contratoEntity.departamento ? contratoEntity.departamento.id : ''}</dd>
          <dt>
            <Translate contentKey="fsijhipsterApp.contrato.empleado">Empleado</Translate>
          </dt>
