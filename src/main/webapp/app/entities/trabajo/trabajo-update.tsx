  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.trabajo.home.createOrEditLabel" data-cy="TrabajoCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.trabajo.home.createOrEditLabel">Create or edit a Trabajo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.trabajo.tituloTrabajo')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.trabajo.salarioMin')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.trabajo.salarioMax')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.trabajo.tarea')}
                id="trabajo-tarea"
                data-cy="tarea"
                type="select"
                multiple
              ...
              <ValidatedField
                ...
                name="empleado"
                data-cy="empleado"
                label={translate('fsijhipsterApp.trabajo.empleado')}
                type="select"
              >
                <option value="" key="0" />
                {empleados
