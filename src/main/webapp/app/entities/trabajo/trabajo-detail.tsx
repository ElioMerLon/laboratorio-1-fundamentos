    ...
    <Row>
      <Col md="8">
        <h2 data-cy="trabajoDetailsHeading">
          <Translate contentKey="fsijhipsterApp.trabajo.detail.title">Trabajo</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="fsijhipsterApp.trabajo.tarea">Tarea</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="fsijhipsterApp.trabajo.empleado">Empleado</Translate>
          </dt>
