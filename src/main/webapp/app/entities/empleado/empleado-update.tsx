  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fsijhipsterApp.empleado.home.createOrEditLabel" data-cy="EmpleadoCreateUpdateHeading">
            <Translate contentKey="fsijhipsterApp.empleado.home.createOrEditLabel">Create or edit a Empleado</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.nombres')}
                id="empleado-nombres"
                name="nombres"
                data-cy="nombres"
                type="text"
              />
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.apellidos')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.correo')}
                id="empleado-correo"
                name="correo"
                data-cy="correo"
                type="text"
              />
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.nroCelular')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.fechacontrato')}
              ...
              />
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.salario')}
                id="empleado-salario"
                name="salario"
                data-cy="salario"
                type="text"
              />
              <ValidatedField
                label={translate('fsijhipsterApp.empleado.comisionPorcentaje')}
              ...
              <ValidatedField
                ...
                label={translate('fsijhipsterApp.empleado.inmediatosuperior')}
                type="select"
              >
                <option value="" key="0" />
                {empleados
              ...
              <ValidatedField
                ...
                label={translate('fsijhipsterApp.empleado.departamento')}
                type="select"
              >
                <option value="" key="0" />
                {departamentos
